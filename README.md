...
1. Make sure you have VSCode opened in the folder `ursaworks-control` (**not
   `ursaworks-control-project`**)
...
1. Open the folder `aruw-ursaworks-control-project` in VSCode. Hit the debug tab on the left side or type
...
`/ursaworks-control-project/robot-type/robot_type.hpp` and change the macro defined in this file.
...
The below commands require that your working directory is `/ursaworks-control-project` (where the
